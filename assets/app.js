...
function trackPurchase(planKey, plan){
  ...
  window.gtag('event', 'purchase', {
    ...
    transaction_id: 'salesmart_' + Date.now(),
...
async function generateAI(){
  ...
  const prompt = `SaleSmart AI tool: ${tool}\nProduct/topic: ${product}\nDetails:\n${details}\n\nCreate a professional, detailed ecommerce output tailored to this specific tool. Use clear headings, bullets, marketplace-specific advice, and practical next actions.`;
